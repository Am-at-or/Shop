		...
		<form:form class="form-horizontal" action="/admin/display"
			...
			<div class="form-group">
				<label for="displaysize" class="col-sm-2 control-label">Display
					Size</label>
				<div class="col-sm-10">
					<form:select class="form-control" path="displaysize"
						id="displaysize" items="${displaysizes}" itemValue="id"
						itemLabel="size" />
				</div>
			</div>
			<div class="form-group">
				<label for="displaywidth" class="col-sm-2 control-label">Resolution
					Width</label>
				<div class="col-sm-10">
					<form:select class="form-control" path="displaywidth"
						id="displaywidth" items="${displaywidths}" itemValue="id"
						itemLabel="width" />
				</div>
			</div>
			<div class="form-group">
				<label for="displayheight" class="col-sm-2 control-label">Resolution
					Height</label>
				<div class="col-sm-10">
					<form:select class="form-control" path="displayheight"
						id="displayheight" items="${displayheights}" itemValue="id"
						itemLabel="height" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:select class="form-control" path="displaytechnology"
