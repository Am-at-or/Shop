...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<form:form class="form" action="/admin/displayvalue" method="POST"
				...
				<custom:hiddenInputs excludeParams="value" />
	...
	<div class="row">
		<div class="col-md-4">
			<form:form class="form-horizontal" action="/admin/displayvalue"
			...
			<div class="col-md-1 text-left">
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						<custom:sort innerHtml="Size asc" paramValue="value" />
						<custom:sort innerHtml="Size desc" paramValue="value,desc" />
					</ul>
				</div>
			</div>
	...
	<div class="row">
		<table class="table table-striped text-center">
			...
			<c:forEach items="${page.content}" var="displayvalue">
				<tr>
					<td>${displayvalue.value}</td>
					<td><a class="btn btn-warning"
						href="/admin/displayvalue/update/${displayvalue.id}<custom:allParams/>">Update</a></td>
					<td><a class="btn btn-danger"
						href="/admin/displayvalue/delete/${displayvalue.id}<custom:allParams/>">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
