...
<div class="container-fluid">
			...
			<form:form class="form" action="/admin/osname" method="POST"
				...
				<div class="form-group">
					<div class=" col-md-4 col-md-offset-4">
						...
						<a href="/admin/osname/cancel<custom:allParams/>"><button type="button"
	...
	<div class="row">
		<div class="col-md-4">
			<form:form class="form-inline" action="/admin/osname" method="GET"
	...
	<div class="row">
		<table class="table table-striped text-center">
			...
			<c:forEach items="${page.content}" var="osname">
				<tr>
					<td>${osname.name}</td>
					<td><a class="btn btn-warning"
						href="/admin/osname/update/${osname.id}<custom:allParams/>">Update</a></td>
					<td><a class="btn btn-danger"
						href="/admin/osname/delete/${osname.id}<custom:allParams/>">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
