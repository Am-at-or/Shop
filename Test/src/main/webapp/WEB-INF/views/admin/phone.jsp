	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<form:form class="form" action="/admin/phone" method="POST"
				...
				<custom:hiddenInputs
					excludeParams="maker, model, price, displayValue, displayResolution, primaryCamera, secondaryCamera, processor, ram, internal, card, numberOfSimCards, operatingSystem, battery, color" />
				<div class="row">
					<div class="col-md-12">
	...
	<div class="row">
		<div class="col-md-10">
			<form:form class="form-horizontal" action="/admin/phone" method="GET"
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							<label for="minDisplayValue" class="control-label">Display
								value</label>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="form-group">
							...
							<form:input path="modelFilter" class="form-control" placeholder="Model" />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
							<label for="numberOfSimCardsFilter" class="control-label">Number
								of SIM</label>
				...
				<div class="row">
					...
					<div class="col-md-2 text-right">
						<div class="form-group">
							<button type="submit" class="btn btn-primary btn-below" style="width: 63px">Ok</button>
						</div>
					</div>
				</div>
			</form:form>
		...
		<div class="col-md-2">
			<div class="col-md-6 text-left">
				<div class="dropdown">
					<button class="btn btn-primary dropdown-toggle pag-below"
					...
					<ul class="dropdown-menu">
						...
						<custom:sort innerHtml="Internal memory asc" paramValue="internal" />
			...
			<div class="col-md-6 text-right pag-below">
